<template>
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <img src="/logo.png" alt="Tranquility Haven Logo" class="w-24 h-auto" />
      </div>
        ...
        <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2024 Tranquility Haven, Inc. All rights reserved.</p>
      </div>
    </footer>
  </template>
