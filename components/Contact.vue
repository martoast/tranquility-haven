      ...
      <div class="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div class="bg-gray-50 px-6 py-16 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div class="mx-auto max-w-lg">
            ...
            <p class="mt-3 text-lg leading-6 text-gray-500">Whether you're seeking housing, want to partner with us, or just have questions, we're here to help.</p>
            <dl class="mt-8 text-base text-gray-500">
              ...
              <div class="mt-6">
                ...
                <dd class="flex">
                  ...
                  <span class="ml-3">404-954-1468</span>
                </dd>
              </div>
              <div class="mt-3">
                ...
                <dd class="flex">
                  ...
                  <span class="ml-3">APlace2Reside@gmail.com</span>
                </dd>
              </div>
            </dl>
          ...
          <div class="mx-auto max-w-lg lg:max-w-none">
            <form action="#" method="POST" class="grid grid-cols-1 gap-y-6">
              ...
              <div>
                ...
                <textarea id="message" name="message" rows="4" class="block w-full rounded-md border-gray-300 px-4 py-3 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Message" />
              </div>
              <div>
